Use this skill when helping the user set up allowed value lists, create category-subcategory relationships, link columns across tables via reference domains, or manage hierarchical master data structures in Eddytor.
...
Recommended procedure for a category → subcategory → product_type chain:
